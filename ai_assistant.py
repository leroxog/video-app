...
_ARTIFACT_PROTOCOL = (
    ...
    "Kamera-Distanz zum Zentrum ändern (einfaches Zoomen). Mit Licht (z.B. "
    "THREE.DirectionalLight + AmbientLight) und Materialien, damit es plastisch wirkt. Setze die "
    "Geometrie aus mehreren einfachen Formen (Box/Sphere/Cylinder/Cone) so zusammen, dass sie "
    "erkennbar der Anfrage entspricht (z.B. bei 'ein Auto' Karosserie, Räder und Fenster aus "
    "mehreren Grundformen, nicht nur ein einzelner Würfel), nicht nur eine leere Szene."
)
